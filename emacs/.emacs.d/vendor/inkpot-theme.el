...
;; Version: 0.1
;;
;; Modified by Aron Griffis <aron@arongriffis.com> to refrain from setting
;; background color
...
(custom-theme-set-faces
  'inkpot 
        '(default ((t (:foreground "#e6e6e6"))))
        '(font-lock-builtin-face ((t (:foreground "#e6e6e6"))))
        '(region ((t (:background "#404040"))))
        '(highlight ((t (:background "#404040"))))
        '(fringe ((t (:background "#1e1e27" :foreground "#e6e6e6"))))
