...
"       hi Normal         gui=NONE   guifg=#cfbfad   guibg=#1e1e27
        hi Normal         gui=NONE   guifg=#e6e6e6   guibg=#1e1e27
    else
"       hi Normal         gui=NONE   guifg=#cfbfad   guibg=#000000
        hi Normal         gui=NONE   guifg=#e6e6e6   guibg=#000000
    endif
...
"       Uncomment the following line to allow vim to set the background to
"       black.  By commenting it, the default background sticks, such as
"       a transparent terminal. -- 21 Oct 2008 agriffis
